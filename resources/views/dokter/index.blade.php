...
@section('content')
    ...
    <!-- Modal -->
    <div id="addDokterModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
        <div class="bg-white rounded-lg shadow-lg w-1/3 p-6 relative">
            <!-- Modal Header with Close Button -->
            <div class="flex justify-between items-center mb-4">
                <h5 class="text-2xl font-bold">Tambah Dokter</h5>
                <button id="closeModalButton" class="text-gray-500 hover:text-gray-700 text-3xl">&times;</button>
            </div>

            <!-- Modal Body -->
            <div class="modal-body">
                <form id="addDokterForm">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-input mt-1 block w-full border-2 rounded-md p-2"
                            id="spesilais" name="spesialis" required>
                    </div>
                    <div class="mb-4">
...
@push('scripts')
    <script>
        ...
        const modal = document.getElementById('addDokterModal');
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            const editUrl = `/dokter/${row.id}/edit`;
                            const deleteUrl = `/dokter/${row.id}`;
                            return `
